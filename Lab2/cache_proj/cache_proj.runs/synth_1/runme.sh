...
HD_PWD='C:/Users/brian/Documents/SchoolPapers/Repositories/CPE 333/CPE-333-Comp.-Arch-/Lab2/cache_proj/cache_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_testbench.tcl
